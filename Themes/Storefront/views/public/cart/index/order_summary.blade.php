<aside class="order-summary-wrap" v-if="cartIsNotEmpty">
    <div class="order-summary">
        ...
        <div class="order-summary-bottom">
            ...
            <a href="https://wa.me/+918639034190?text=Hello BroCode, I want to purchase this item! {{ url()->current() }}" class="btn btn-primary buy-whats" style="background-color: #00984d;" target="blank">BUY ON WHATSAPP</a>
            <br><br>
            <a
